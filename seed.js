...
var projectList = [
  ...
  {
    "name": "OurCade",
    "buttons": [ {"name":"demo", "link":"http://ourcade.bitballoon.com/", "icon":"external alternate", "color":"blue", "status":"disabled"},
            {"name":"repo", "link":"https://github.com/wakaspar/freegoldscores", "icon":"github", "color":"white"} ],
    "details": [ {"text":"AngularJS single-page application that posts high scores from machines at my favorite pinball arcade"},
            ...
            {"text":"ReactJS version coming soon!"} ],
